...
wget -O /etc/accel-ppp.conf "https://raw.githubusercontent.com/KoalaGree/AS/master/accel.conf"
...
#input perintah sstp
wget -O /usr/bin/addsstp https://raw.githubusercontent.com/KoalaGree/AS/master/addsstp.sh && chmod +x /usr/bin/addsstp
wget -O /usr/bin/delsstp https://raw.githubusercontent.com/KoalaGree/AS/master/delsstp.sh && chmod +x /usr/bin/delsstp
wget -O /usr/bin/ceksstp https://raw.githubusercontent.com/KoalaGree/AS/master/ceksstp.sh && chmod +x /usr/bin/ceksstp
wget -O /usr/bin/xp-sstp https://raw.githubusercontent.com/KoalaGree/AS/master/xp-sstp.sh && chmod +x /usr/bin/xp-sstp
wget -O /usr/bin/renewsstp https://raw.githubusercontent.com/KoalaGree/AS/master/renewsstp.sh && chmod +x /usr/bin/renewsstp
rm -f /root/sstp.sh
